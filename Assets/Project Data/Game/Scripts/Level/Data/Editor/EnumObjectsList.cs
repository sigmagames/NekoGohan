...
namespace Watermelon.BubbleMerge
{
    public class EnumObjectsList
    {
        ...
        {
            EditorGUILayout.LabelField(tabLabel, WatermelonEditor.Styles.label_large_bold);
            ...
            for (int index = 0; index < array.arraySize; index++)
            {
                ...
                EditorGUILayout.LabelField(tempPropertyLabel, WatermelonEditor.Styles.label_medium);
            ...
            if (GUILayout.Button(EDIT_ENUM, WatermelonEditor.Styles.button_01, GUILayout.Height(EditorGUIUtility.singleLineHeight * 2)))
            {
                StartEditMode();
            }
        ...
        {
            EditorGUILayout.LabelField(ENUM, WatermelonEditor.Styles.label_large_bold);
            ClearValidation();
            ...
            if (GUILayout.Button(CANCEL, WatermelonEditor.Styles.button_03, GUILayout.Height(EditorGUIUtility.singleLineHeight * 2)))
            {
        ...
        private void MoveEnumView()
        {
            ...
            for (int index = 0; index < maxPosition; index++)
            {
                ...
                {
                    if (GUILayout.Button($"Place here (new value: {index})", WatermelonEditor.Styles.button_05))
                    {
